...
let allButton = document.querySelectorAll("buttons");
console.log("count of buttons is ${allButton.length}");
...
console.log(topics.previousElementSibling).innerText = "Walking in DOM"
// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.
topics.firstElementChild.innerText = 
